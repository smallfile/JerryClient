...
public class NotificationMinSetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_file_download_notification_minset);
    }
    ...
    public static class NotificationItem extends BaseNotificationItem {
        ...
        private NotificationItem(int id, String title, String desc) {
            ...
            intents[0] = Intent.makeMainActivity(new ComponentName(MyApplication.getApplication(),
                    FileDownloadMainActivity.class));
            intents[1] = new Intent(MyApplication.getApplication(), NotificationSampleActivity.class);

            this.pendingIntent = PendingIntent.getActivities(MyApplication.getApplication(), 0, intents,
