...
import com.jerry.uilib.frame.indicator.view.indicator.BannerComponent;
...
import com.jerry.uilib.frame.indicator.view.indicator.slidebar.ScrollBar;
...
public class BannerActivity extends Activity {
    ...
    protected void onCreate(Bundle arg0) {
        super.onCreate(arg0);
        setContentView(R.layout.activity_tab_indicator_banner);
        ...
        findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                images = new int[]{R.drawable.tab_indicator_p2};
        ...
        findViewById(R.id.button2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                images = new int[]{R.drawable.tab_indicator_p1, R.drawable.tab_indicator_p2, R.drawable.tab_indicator_p3, R.drawable.tab_indicator_p4};
                adapter.notifyDataSetChanged();
            }
        });
...
//        bannerComponent.setScrollDuration(800);
    ...
    private int[] images = {R.drawable.tab_indicator_p1, R.drawable.tab_indicator_p2, R.drawable.tab_indicator_p3, R.drawable.tab_indicator_p4};
