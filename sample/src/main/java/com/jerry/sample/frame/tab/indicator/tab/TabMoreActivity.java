package com.jerry.sample.frame.tab.indicator.tab;
...
import com.jerry.uilib.frame.indicator.view.indicator.IndicatorViewPager.IndicatorFragmentPagerAdapter;
import com.jerry.uilib.frame.indicator.view.indicator.ScrollIndicatorView;
import com.jerry.uilib.frame.indicator.view.indicator.slidebar.DrawableBar;
import com.jerry.uilib.frame.indicator.view.indicator.slidebar.ScrollBar.Gravity;
import com.jerry.uilib.frame.indicator.view.indicator.transition.OnTransitionTextListener;

public class TabMoreActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_indicator_tabmore);
        ...
        scrollIndicatorView.setScrollBar(new DrawableBar(this, R.drawable.tab_indicator_round_border_white_selector, Gravity.CENTENT_BACKGROUND) {
            @Override
    ...
    private OnCheckedChangeListener onCheckedChangeListener = new OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            if (buttonView == splitAutotoggleButton) {
                ...
                scrollIndicatorView.setPinnedShadow(R.drawable.tab_indicator_shadow, dipToPix(4));
