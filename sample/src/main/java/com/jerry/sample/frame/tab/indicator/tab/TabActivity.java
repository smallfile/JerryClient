...
import com.jerry.uilib.frame.indicator.view.viewpager.SViewPager;
...
public class TabActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle arg0) {
        super.onCreate(arg0);
        setContentView(R.layout.activity_tab_indicator_tab);
        ...
        centerView = getLayoutInflater().inflate(R.layout.tab_indicator_main_center, indicator, false);
    ...
    private class MyAdapter extends IndicatorFragmentPagerAdapter {
        ...
        private int[] tabIcons = {R.drawable.tab_indicator_maintab_1_selector,
                                R.drawable.tab_indicator_maintab_2_selector,
                                R.drawable.tab_indicator_maintab_3_selector,
                                R.drawable.tab_indicator_maintab_4_selector};
        ...
        public View getViewForTab(int position, View convertView, ViewGroup container) {
            if (convertView == null) {
                convertView = inflater.inflate(R.layout.tab_indicator_main, container, false);
            }
