...
public class TasksManagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_file_download_task_manager);
        ...
        public void updateDownloading(final int status, final long sofar, final long total) {
            ...
            switch (status) {
                ...
                case FileDownloadStatus.progress:
                    ...
                    break;
                default:
                    taskStatusTv.setText(MyApplication.getApplication().getString(
    ...
    private static class TaskItemAdapter extends RecyclerView.Adapter<TaskItemViewHolder> {
        ...
        public TaskItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            TaskItemViewHolder holder = new TaskItemViewHolder(
                    LayoutInflater.from(
                            parent.getContext())
                            .inflate(R.layout.item_file_download_task_manager, parent, false));
    ...
    private static class TasksManagerDBController {
        ...
        private TasksManagerDBController() {
            TasksManagerDBOpenHelper openHelper = new TasksManagerDBOpenHelper(MyApplication.getApplication());
        ...
        public TasksManagerModel addTask(final String url, final String path) {
            ...
            TasksManagerModel model = new TasksManagerModel();
            model.setId(id);
            model.setName(MyApplication.getApplication().getString(R.string.tasks_manager_demo_name, id));
            model.setUrl(url);
            model.setPath(path);
