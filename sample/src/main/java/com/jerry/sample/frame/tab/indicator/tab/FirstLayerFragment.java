...
import com.jerry.uilib.frame.indicator.fragment.LazyFragment;
...
import com.jerry.uilib.frame.indicator.view.indicator.slidebar.LayoutBar;
...
public class FirstLayerFragment extends LazyFragment {
	...
	protected void onCreateViewLazy(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fragment_tab_indicator);
		...
		case 2:
			...
			break;
		case 3:
			indicator.setScrollBar(new LayoutBar(getApplicationContext(), R.layout.fragment_layout_slidebar, Gravity.CENTENT_BACKGROUND));
			break;
		}
