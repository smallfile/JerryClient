...
public class GuideActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle arg0) {
        super.onCreate(arg0);
        setContentView(R.layout.activity_tab_indicator_guide);
        ...
        new Thread() {
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        images = new int[]{R.drawable.tab_indicator_p3, R.drawable.tab_indicator_p4};
    ...
    private IndicatorPagerAdapter adapter = new IndicatorViewPagerAdapter() {
        ...
        public View getViewForTab(int position, View convertView, ViewGroup container) {
            if (convertView == null) {
                convertView = inflate.inflate(R.layout.tab_indicator_guide, container, false);
            }
            return convertView;
        }
