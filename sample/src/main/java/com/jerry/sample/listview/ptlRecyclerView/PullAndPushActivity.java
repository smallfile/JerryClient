...
import com.jerry.uilib.listview.recyclerview.impl.RefreshView2;
...
public class PullAndPushActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recyclerview_pullpush);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("PullAndPushActivity");
...
//        GridLayoutManager layoutManager = new GridLayoutManager(this,3);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.recyclerview_menu_pullpush,menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            break;
            case R.id.error: {
                ViewGroup errorView = (ViewGroup) LayoutInflater.from(this).inflate(R.layout.recyclerview_load_error,(ViewGroup) findViewById(android.R.id.content),false);
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHoader>{
        ...
        public ViewHoader onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_item_pullpush,parent,false);
