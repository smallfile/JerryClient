...
public class SwipeMenuActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recyclerview_swipemenu);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("SwipeMenuActivity");
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHoader>{
        ...
        public ViewHoader onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).
                    inflate(R.layout.recyclerview_item_swipe,parent,false);
        ...
        public void onBindViewHolder(final ViewHoader holder, int position) {
            ...
            holder.btOpen.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(SwipeMenuActivity.this, "Open " + str, Toast.LENGTH_SHORT).show();
                }
            });
