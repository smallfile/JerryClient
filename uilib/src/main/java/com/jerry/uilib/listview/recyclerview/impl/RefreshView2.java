package com.jerry.uilib.listview.recyclerview.impl;
...
public class RefreshView2 extends BaseRefreshView {
    ...
    protected void init(Context context) {
        super.init(context);
        headerView = LayoutInflater.from(context).inflate(R.layout.recyclerview_refresh1,null);
        ...
        secondIv.setBackgroundResource(R.drawable.recyclerview_anim_second);
        secondAnim = (AnimationDrawable) secondIv.getBackground();
        threeIv.setBackgroundResource(R.drawable.recyclerview_anim_third);
