...
public class CalendarPickerView extends ListView {
  ...
  public CalendarPickerView(Context context, AttributeSet attrs) {
    ...
    dividerColor = a.getColor(R.styleable.CalendarPickerView_calendarDividerColor,
        res.getColor(R.color.calendar_divider));
    dayBackgroundResId = a.getResourceId(R.styleable.CalendarPickerView_calendarDayBackground,
        R.drawable.calendar_bg_selector);
    dayTextColorResId = a.getResourceId(R.styleable.CalendarPickerView_calendarDayTextColor,
        R.color.calendar_text_selector);
    titleTextColor =
        a.getColor(R.styleable.CalendarPickerView_calendarTitleTextColor, R.color.calendar_text_active);
    headerTextColor =
        a.getColor(R.styleable.CalendarPickerView_calendarHeaderTextColor, R.color.calendar_text_active);
    a.recycle();
    ...
    monthNameFormat = new SimpleDateFormat(context.getString(R.string.calendar_month_name_format), locale);
    weekdayNameFormat = new SimpleDateFormat(context.getString(R.string.calendar_day_name_format), locale);
  ...
  public FluentInitializer init(Date minDate, Date maxDate, Locale locale) {
    ...
    monthCounter = Calendar.getInstance(locale);
    monthNameFormat =
        new SimpleDateFormat(getContext().getString(R.string.calendar_month_name_format), locale);
    for (MonthDescriptor month : months) {
      month.setLabel(monthNameFormat.format(month.getDate()));
    }
    weekdayNameFormat =
        new SimpleDateFormat(getContext().getString(R.string.calendar_day_name_format), locale);
    fullDateFormat = DateFormat.getDateInstance(DateFormat.MEDIUM, locale);
  ...
  public class FluentInitializer {
    ...
    public FluentInitializer setShortWeekdays(String[] newShortWeekdays) {
      ...
      weekdayNameFormat =
          new SimpleDateFormat(getContext().getString(R.string.calendar_day_name_format), symbols);
      return this;
    }
  ...
  private class DefaultOnInvalidDateSelectedListener implements OnInvalidDateSelectedListener {
    @Override public void onInvalidDateSelected(Date date) {
      String errMessage =
          getResources().getString(R.string.calendar_invalid_date, fullDateFormat.format(minCal.getTime()),
