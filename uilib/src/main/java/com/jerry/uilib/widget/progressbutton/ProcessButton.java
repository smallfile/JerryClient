package com.jerry.uilib.widget.progressbutton;
...
public abstract class ProcessButton extends FlatButton {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mProgressDrawable = (GradientDrawable) getDrawable(R.drawable.process_button_progress).mutate();
        mProgressDrawable.setCornerRadius(getCornerRadius());

        mCompleteDrawable = (GradientDrawable) getDrawable(R.drawable.process_button_complete).mutate();
        mCompleteDrawable.setCornerRadius(getCornerRadius());

        mDisableDrawable = (GradientDrawable) getDrawable(R.drawable.process_button_disable).mutate();
        mDisableDrawable.setCornerRadius(getCornerRadius());
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            int purple = getColor(R.color.progress_button_purple_progress);
            ...
            int green = getColor(R.color.progress_button_green_complete);
            int colorComplete = attr.getColor(R.styleable.ProcessButton_pb_colorComplete, green);
            mCompleteDrawable.setColor(colorComplete);

            int gray = getColor(R.color.progress_button_gray_disable);
            int colorDisable = attr.getColor(R.styleable.ProcessButton_pb_colorDisable, gray);
            mDisableDrawable.setColor(colorDisable);
        } finally {
            attr.recycle();
        }
    }
    ...
    public void setDisableDrawable(GradientDrawable disableDrawable) {
        mDisableDrawable = disableDrawable;
    }
