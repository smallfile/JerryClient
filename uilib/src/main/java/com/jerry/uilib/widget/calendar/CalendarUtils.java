package com.jerry.uilib.widget.calendar;
...
public class CalendarUtils {
	...
	public static final String DAY_SUNDAY = "星期日";
	public static final String DAY_MONDAY = "星期一";
	public static final String DAY_TUESDAY = "星期二";
	public static final String DAY_WEDNESDAY = "星期三";
	public static final String DAY_THURSDAY = "星期四";
	public static final String DAY_FRIDAY = "星期五";
	public static final String DAY_SATURDAY = "星期六";
	
	// 得到这一天是星期几
	public String getDayOfWeek(int position) {
		String week = DAY_SUNDAY;
		switch (position % 7) {
		case 0:
			week = DAY_SUNDAY;
			break;
