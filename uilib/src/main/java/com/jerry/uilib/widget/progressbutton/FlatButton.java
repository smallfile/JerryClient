...
public class FlatButton extends Button {
    ...
    private LayerDrawable createNormalDrawable(TypedArray attr) {
        LayerDrawable drawableNormal =
                (LayerDrawable) getDrawable(R.drawable.process_button_normal).mutate();
        ...
        int blueDark = getColor(R.color.progress_button_blue_pressed);
        ...
        int blueNormal = getColor(R.color.progress_button_blue_normal);
    ...
    private Drawable createPressedDrawable(TypedArray attr) {
        GradientDrawable drawablePressed =
                (GradientDrawable) getDrawable(R.drawable.process_button_pressed).mutate();
