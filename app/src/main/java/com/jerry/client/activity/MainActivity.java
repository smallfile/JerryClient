...
import com.jerry.client.fragment.ChatFragment;
import com.jerry.client.fragment.MeFragment;
import com.jerry.client.R;
import com.jerry.client.fragment.ContactFragment;
import com.jerry.client.fragment.FoundFragment;
    ...
    private void changeSelectedTabState(int position) {
        switch (position) {
            case 0:
                ...
                mImageChat.setBackgroundResource(R.drawable.tab_chat_selected);
                break;
            case 1:
                mTextContact.setTextColor(Color.parseColor("#0099ff"));
                mImageContact.setBackgroundResource(R.drawable.tab_contact_selected);
                break;
            case 2:
                mTextFind.setTextColor(Color.parseColor("#0099ff"));
                mImageFind.setBackgroundResource(R.drawable.tab_found_selected);
                break;
            case 3:
                mTextMe.setTextColor(Color.parseColor("#0099ff"));
                mImageMe.setBackgroundResource(R.drawable.tab_me_selected);
                break;
        }
    }
