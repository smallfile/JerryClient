...
import com.jerry.client.adapter.WelcomePagerAdapter;
import com.jerry.client.config.Config;
...
public class WelcomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private ImageView[] points;  //底部指示器(小圆点)的图片
    private int currentIndex;   //当前选中的指针
